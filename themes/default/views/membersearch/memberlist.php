                         ...
                         <?php } ?>
                            <div class="grid-container clear">
                               ...
                               <?php foreach ($users as $value) { ?>
                                 ...
                                 <img src="<?php echo Yii::app()->request->baseUrl; ?>/upload/profile/<?php echo $value->profile_picture;?>" alt="" />
                                 <?php } else {?>
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/member/blank-img-300x258.jpg" alt="" />
                                        <?php } ?>
                                        <span class="rollover">
                                        <strong><a href="#"><?php echo $value->first_name.''.$value->last_name;?></a></strong><br> 
                                      <?php echo $value->occupation;?></span>
                                 </li>
                                 <?php } ?>
                              </ul>
