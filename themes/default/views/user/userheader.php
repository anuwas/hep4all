                                  ...
                                  <article class="span8">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right">
                                           <tr>
                                                ...
                                                <div>
                                                <article class="span4 link2"> &nbsp;</article>
                                                <article class="span8 link"> <?php echo Yii::app()->session['first_name']. " ".Yii::app()->session['last_name'];?> | <a href="<?php echo Yii::app()->request->baseUrl; ?>/user/profile">Manage Account</a> | <a href="<?php echo Yii::app()->request->baseUrl; ?>/users/logout">Log Out</a></article>
                                                </div>
                                               </td>
                                          </tr>
                                              <?php 
