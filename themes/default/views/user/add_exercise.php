					...
					<section class="container">
                       ...
                       <?php include 'menu.php';?>
                         ...
                         <article class="span1"></article>
                           <article class="span9">
                           <form name="exerForm" id="exerForm" action="<?php echo Yii::app()->request->baseUrl; ?>/user/addexercise" enctype="multipart/form-data" method="post">
                        ...
                        <div id="exercise_type_msg" class="alert alert-error  error">
                        ...
                        <table width="100%" align="left" border="0" cellspacing="0" cellpadding="5">
                               <tr>
                                ...
                                <option value="<?php echo $value->exercise_type_id;?>"><?php echo $value->exercise_type_name;?></option>
                                
                                <?php } ?>
                                </select></td>
                               </tr>
                              <tr>
                               <td><input name="Exercises[exercise_title]" id="Exercises_exercise_title" type="text" placeholder="Title of Exercise"></td>
                               <td>&nbsp;</td>
                               <td><select id="Exercises_main_category" name="Exercises[main_category]" onchange="" >
                                <option value="-1">--- Main Category ---</option>
                                <?php foreach ($exercisecategory as $value) { ?>
                                
                                <option value="<?php echo $value->exercise_category_id;?>"><?php echo $value->exercise_category_name;?></option>
                              ...
                              <tr>
                                <td colspan="3"><select id="Exercises_sub_category" name="sub_category[]" size="5" multiple="multiple">
                                    ...
                                    <option value="<?php echo $value->exercise_sub_category_id;?>"><?php echo $value->exercise_sub_category_name;?></option>
                              ...
                              <tr>
                                <td colspan="3"><select id="Exercises_position_id" name="Exercises[position_id]">
                                    ...
                                    <option value="<?php echo $value->position_master_id;?>"><?php echo $value->position_master_name;?></option>
                                   
                                    <?php } ?>
                                    </select></td>                               
                              </tr>
                              <tr>
                                <td colspan="3"><textarea id="Exercises_description" name="Exercises[description]" cols="50" rows="7" placeholder="Describe how to perform the exercise"></textarea></td>
                              </tr>
                              <tr>
                                  <td colspan="3">
                                ...
                                <div class="fileUpload btn btn-primary">
                                    ...
                                    <input id="ytExercises_picture_1" type="hidden" value="" name="Exercises[picture_1]">
                                ...
                                <span style="position: absolute;margin-left: 4px;margin-top: -15px;">Standard Image Size (820 X 720)px</span>
                                  ...
                                  <tr>
                                  <td colspan="3"><input id="uploadFile2" placeholder="Picture 2" disabled="disabled" />
                                <div class="fileUpload btn btn-primary">
                                    <span>Upload File</span>
                                    <input id="uploadBtn2" type="file" class="upload" name="Exercises[picture_2]" />
                                    <input id="ytExercises_picture_2" type="hidden" value="" name="Exercises[picture_2]">
                                </div>
                                 <br>
                                <br>
                                <span style="position: absolute;margin-left: 4px;margin-top: -15px;">Standard Image Size (820 X 720)px</span>
                                  ...
                                  <tr>
                                  <td colspan="3"><input id="uploadFile3" placeholder="Video 1" disabled="disabled" />
                                <div class="fileUpload btn btn-primary">
                                    <span>Upload File</span>
                                    <input id="uploadBtn3" type="file" class="upload" name="Exercises[video_1]"/>
                                    <input id="ytExercises_video_1" type="hidden" value="" name="Exercises[video_1]">
                                </div></td>
                                    
                                  </tr>
                                  <tr>
                                  <td colspan="3"><input id="uploadFile4" placeholder="Video 2" disabled="disabled" />
                                <div class="fileUpload btn btn-primary">
                                    <span>Upload File</span>
                                    <input id="uploadBtn4" type="file" class="upload" name="Exercises[video_2]"/>
                                    <input id="ytExercises_video_2" type="hidden" value="" name="Exercises[video_2]">
                                </div></td>
                                  ...
                                  <tr>
                                  <td colspan="3">
                                  <input name="Exercises[productlink]" id="Exercises_productlink" type="text" placeholder="Product Link" >
...
$(document).ready(function(){
	...
	{$("#position_erroe_msg").hide();
		}

	var extype=$("#Exercises_exercise_access_type").show();
	if(extype=="-1")
	{
		$("#exercise_type_msg").show();
		$('html, body').animate({scrollTop : 0},800);
		return false;
		}
	else
	{
		$("#exercise_type_msg").hide();
		}
