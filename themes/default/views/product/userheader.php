                                              ...
                                              <td class="md">&nbsp;</td>
                                                ...
                                                <td width="25%"><select name="search_option" id="search_option">
                                                    ...
                                                    <?php foreach ($allcategory as $value) { ?>
                                                    	<option value="<?php echo $value->product_category_id;?>" <?php if($search_option==$value->product_category_id){?> selected="selected"<?php } ?>><?php echo $value->product_category_name;?></option>
                                                   <?php  }?>
