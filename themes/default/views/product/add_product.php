					...
					<section class="container">
                       ...
                       <?php include 'menu.php';?>
                               <div>
                                 <table width="100%" border="0" cellspacing="4" cellpadding="4">
                                  <tr>
                                    ...
                                    <td valign="middle"><h3>ADD PRODUCT</h3></td>
                                    <td align="right">&nbsp;</td>
                                  </tr>
                                </table>
                                <table width="100%" border="0" cellspacing="4" cellpadding="4">
                         ...
                         <article class="span1"></article>
                           <article class="span9">
                           <form name="exerForm" id="exerForm" action="<?php echo Yii::app()->request->baseUrl; ?>/product/add" enctype="multipart/form-data" method="post">
                        ...
                        <table width="100%" align="left" border="0" cellspacing="0" cellpadding="5">
                              <tr>
                                <td colspan="3"><input name="Product[product_name]" id="Product_product_name" type="text" placeholder="Product Name"></td>
                              </tr>
                              <tr>
                                <td colspan="3"><textarea id="Product_product_desc" name="Product[product_desc]" cols="50" style="width: 492px;" rows="7" placeholder="Product Description"></textarea></td>
                              </tr>
                              <tr>
                               <td colspan="3">
                               <select id="Product_category_id" name="Product[category_id]" onchange="" >
                                ...
                                <tr>
                               <td colspan="3"><input name="Product[product_link]" id="Product_product_link" type="text" placeholder="Product Link"></td>
                              </tr>
                              <tr>
                               <td colspan="3"><input name="Product[price]" id="Product_price" type="text" placeholder="Price"></td>
                              </tr>
                               <tr>
                                  <td colspan="3">
                                ...
                                <div class="fileUpload btn btn-primary">
                                    ...
                                    <input id="ytExercises_picture_1" type="hidden" value="" name="Product[product_image]">
