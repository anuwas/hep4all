						...
						<div class="row add-top-half add-bottom-half">
                         ...
                         <div class="print">
                                <ul>
                                  ...
                                  <li> <a target="_blank" href="<?php echo Yii::app()->request->baseUrl; ?>/printexercise/reusetemplate/<?php echo $_REQUEST['id']?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/icons/print.png" title="Print"/> Print</a> </li>
