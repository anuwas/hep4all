                ...
                <section class="container">
                    <div class="row add-top-half add-bottom-half">
                           <article class="span12"> 
                            ...
                            <article class="span5"> 
                             <div>
                               <table width="100%" border="0" cellspacing="5" cellpadding="5">
                                  <tr>
                                    <td> Routine Name</td>
                                    <td><input name="routene_name" id="routene_name" type="text" placeholder="Home Exercise Program" readonly="readonly"></td>
                                  </tr>
                                  <tr>
                                    <td>Date Created
                                    
                                    </td>
                                    <td><input name="first-name" id="first-name" type="text" placeholder="<?php echo date("m/d/Y",strtotime($printexercise[count($printexercise)-1]->created_date));?>" readonly="readonly"></td>
                                  </tr>
                                </table>
                            ...
                            <article class="span3"> 
                              <div align="center"> <a href="#">Remove All</a> <br>  <br><strong>Total:</strong> <?php echo count($printexercise);?></div>
                             </article> 
                             <div class="line2"></div>
                           </article>
                        </div>
