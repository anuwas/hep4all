						...
						<div class="row add-top-half add-bottom-half">
                         ...
                         <div class="print">
                                <ul>
                                  ...
                                  <li> <a target="_blank" href="<?php echo Yii::app()->request->baseUrl; ?>/printexercise/exercisediary" id="print_exercise_log"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/icons/print.png" title="Print"/> Print Log</a> </li>
                                 </ul>
                           </div>
