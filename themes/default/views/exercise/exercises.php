...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/javascripts/init.js"></script> 
 <!--  <link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
  <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/stylesheets/jquery_ui_1.11.4_themes_smoothness_jquery-ui.css">-->
  <style>
...
.tooltip.in{opacity:1; margin-left:-12px !important;}
</style>
  <script>
  /*
  $(function() {
    $( ".tool-open-eventa" ).tooltip({
      show: null,
      position: {
        my: "left top",
        at: "left bottom"
                            ...
                            <div class="grid-container clear">
                               ...
                               <?php foreach ($exercise as $value) { ?>
                                       <li class="ajax-anchor grid-item onebyone light-feature sec-huekit">
                                        ...
                                        <a data-toggle="tooltip"  href="#" title="Click to Large" class="detail_link white-tooltip" id="<?php echo $value->exercise_id;?>">
                                        ...
                                        <a data-toggle="tooltip"  href="javascript:void(0)" title="Add Picture1 and Video1" class="print_figure white-tooltip" id="figure_cloth" exerid="<?php echo $value->exercise_id;?>" picname="<?php echo $value->picture_1;?>">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/icons/plus2.png"/></a> 
                                        <a data-toggle="tooltip"  href="javascript:void(0)" title="Add Picture2 and Video2" class="print_figure white-tooltip" id="figure_massale" exerid="<?php echo $value->exercise_id;?>" picname="<?php echo $value->picture_2;?>">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/icons/plus3.png"/></a>
                                        <?php if($value->productlink){?>
                                         <a data-toggle="tooltip"  href="javascript:void(0)" title="Product" class="view_product white-tooltip" id="<?php echo $value->productlink;?>" target="_blank">
