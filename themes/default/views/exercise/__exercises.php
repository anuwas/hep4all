                            ...
                            <div class="grid-container clear">
                               ...
                               <?php foreach ($exercise as $value) { ?>
                                       ...
                                       <li class="ajax-anchor grid-item onebyone light-feature sec-huekit">
                                        ...
                                        <a href="javascript:void(0)" title="Favorite" class="favourite" id="<?php echo $value->exercise_id;?>_favourite" picname="<?php echo $value->picture_1;?>">
                                        ...
                                        <a href="javascript:void(0)" title="Add Picture1 and Video1" class="print_figure" id="figure_cloth" exerid="<?php echo $value->exercise_id;?>" picname="<?php echo $value->picture_1;?>">
                                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/icons/plus2.png"/></a> 
                                        <a href="javascript:void(0)" title="Add Picture2 and Video2" class="print_figure" id="figure_massale" exerid="<?php echo $value->exercise_id;?>" picname="<?php echo $value->picture_2;?>">
