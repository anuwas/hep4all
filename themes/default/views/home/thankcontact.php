					...
					<section class="container">
						...
						<div class="row add-bottom-half">
							<article class="span12">
                                ...
                                <h2 id="intro-heading2" style="text-align:center !important;">Your message has been sent successfully!<br>
...
$(document).ready(function(){
	window.setTimeout(function() {
		    window.location.href = '<?php echo Yii::app()->request->baseUrl; ?>/#intro';
		}, 3000);
})
</script>
</script>
