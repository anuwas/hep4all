	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Users']))
		{
			...
			if($uploadedFile_app_icon)
			{
				...
				$uploadedFile_app_icon->saveAs(Yii::app()->basePath.'/../upload/'.$fileName_icon);
				$image = Yii::app()->image->load(Yii::app()->basePath.'/../upload/'.$fileName_icon);
				$image->resize(196, 196);
				$image->save(Yii::app()->basePath.'/../upload/'.$fileName_icon);
