...
class ProductController extends Controller
{
	public function actionAdd()
	{
		...
		$this->render('add_product',array('model'=>$user,'productcategory'=>$productcategory));
	}
	...
	public function actionManage()
	{
		...
		$this->render('manage_product',array('model'=>$user,'products'=>$products,'pages'=>$pages,'productcategory'=>$productcategory));
	}
