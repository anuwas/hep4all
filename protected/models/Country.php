...
class Country extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, iso_code_2, iso_code_3, postcode_required', 'required'),
			...
			array('country_id, name, iso_code_2, iso_code_3, postcode_required, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('iso_code_2',$this->iso_code_2);
