...
class ProductCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('product_category_name', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('product_category_id, product_category_name, created_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('product_category_name',$this->product_category_name,true);
