...
class MYPDF extends TCPDF {
 ...
 public function Header() {
 	//echo '<link rel="shortcut icon" href="'.Yii::app()->request->baseUrl.'/images/icons/favicon.png">';
    }
    ...
    $cur_y = $this->y;
		...
		if ($this->getRTL()) {
			...
			$this->Cell(0, 0, $this->getAliasRightShift().'Powered By HEP4all.com And Sponsored by EMR4all.com', 'T', 0, 'L');
